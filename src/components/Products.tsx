...
export default function Products() {
  ...
  const products = [
    ...
    },
    {
      ...
      fullDescription: 'Комплексное решение для автоматизации деятельности многопрофильных предприятий с развитой структурой подразделений, сложными бизнес-процессами, территориально-распределенной структурой. Включает полный спектр функций для управления современным предприятием.',
      icon: 'Factory',
      features: [
    ...
    },
    {
      ...
      fullDescription: 'Специализированное решение для автоматизации розничных предприятий. Обеспечивает учет товародвижения, работу с покупателями, управление ассортиментом, ценами и скидками. Поддерживает различные форматы торговли: магазины, склады, интернет-магазины.',
      icon: 'ShoppingCart',
      features: [
    ...
    },
    {
      ...
      fullDescription: 'Решение для автоматизации основных контуров управления торгово-производственной деятельности предприятия. Включает управление продажами, закупками, складами, производством, финансами, взаимоотношениями с контрагентами.',
      icon: 'Cog',
      features: [
        'Управление продажами',
        'Управление закупками',
