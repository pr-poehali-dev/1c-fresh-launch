      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative w-full z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mt-12 md:mt-16 lg:mt-20">
          {advantages.map((advantage, index) => (
            <Card key={index} className="bg-white/90 backdrop-blur-sm border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-white">
              <CardContent className="p-4 md:p-6 text-center">
                ...
                <h3 className="font-display font-semibold text-sm md:text-base text-gray-900 mb-2 leading-tight">{advantage.title}</h3>
