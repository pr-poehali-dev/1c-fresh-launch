      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative w-full">
        <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
          <div className="text-center lg:text-left order-2 lg:order-1">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-display font-bold text-gray-900 mb-3 md:mb-4 lg:mb-6 leading-tight">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-4 md:mb-6 lg:mb-8 leading-relaxed">
          ...
          <div className="flex justify-center order-1 lg:order-2 mb-4 md:mb-6 lg:mb-0">
            <img 
              src="/img/f9205f3c-fa15-4f45-a4bb-2a473d1a858d.jpg" 
              alt="1C Fresh Solutions" 
              className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg rounded-2xl md:rounded-3xl shadow-xl md:shadow-2xl animate-float"
            />
          </div>
        </div>
